...
class yc_tuple_vector_vnf_pp__reports_snapshots_evaluations_metrics_tuple_vector(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module vnf-pp - based on the path /reports/snapshots/evaluations/metrics/tuple-vector. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['reports', 'snapshots', 'evaluations', 'metrics', 'tuple-vector']

  def _get_key(self):
    """
    Getter method for key, mapped from YANG variable /reports/snapshots/evaluations/metrics/tuple_vector/key (string)
  ...
  def _set_key(self, v, load=False):
    """
    Setter method for key, mapped from YANG variable /reports/snapshots/evaluations/metrics/tuple_vector/key (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_value(self):
    """
    Getter method for value, mapped from YANG variable /reports/snapshots/evaluations/metrics/tuple_vector/value (string)
  ...
  def _set_value(self, v, load=False):
    """
    Setter method for value, mapped from YANG variable /reports/snapshots/evaluations/metrics/tuple_vector/value (string)
    If this variable is read-only (config: false) in the
...
class yc_metrics_vnf_pp__reports_snapshots_evaluations_metrics(PybindBase):
  ...
  def _get_tuple_vector(self):
    """
    Getter method for tuple_vector, mapped from YANG variable /reports/snapshots/evaluations/metrics/tuple_vector (list)
  ...
  def _set_tuple_vector(self, v, load=False):
    """
    Setter method for tuple_vector, mapped from YANG variable /reports/snapshots/evaluations/metrics/tuple_vector (list)
    If this variable is read-only (config: false) in the
