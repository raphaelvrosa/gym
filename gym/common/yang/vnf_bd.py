...
class yc_host_vnf_bd__proceedings_agents_host(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module vnf-bd - based on the path /proceedings/agents/host. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['proceedings', 'agents', 'host']

  def _get_setting(self):
    """
    Getter method for setting, mapped from YANG variable /proceedings/agents/host/setting (string)
  ...
  def _set_setting(self, v, load=False):
    """
    Setter method for setting, mapped from YANG variable /proceedings/agents/host/setting (string)
    If this variable is read-only (config: false) in the
  ...
  def _get_node(self):
    """
    Getter method for node, mapped from YANG variable /proceedings/agents/host/node (string)
  ...
  def _set_node(self, v, load=False):
    """
    Setter method for node, mapped from YANG variable /proceedings/agents/host/node (string)
    If this variable is read-only (config: false) in the
...
class yc_agents_vnf_bd__proceedings_agents(PybindBase):
  ...
  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /proceedings/agents/id (string)
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /proceedings/agents/id (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_id is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_id() directly.
  ...
  def _get_host(self):
    """
    Getter method for host, mapped from YANG variable /proceedings/agents/host (container)
  ...
  def _set_host(self, v, load=False):
    """
    Setter method for host, mapped from YANG variable /proceedings/agents/host (container)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_host_vnf_bd__proceedings_agents_host, is_container='container', yang_name="host", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:ietf:params:xml:ns:yang:vnf-bd', defining_module='vnf-bd', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """host must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_host_vnf_bd__proceedings_agents_host, is_container='container', yang_name="host", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:ietf:params:xml:ns:yang:vnf-bd', defining_module='vnf-bd', yang_type='container', is_config=True)""",
        })
...
class yc_host_vnf_bd__proceedings_monitors_host(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module vnf-bd - based on the path /proceedings/monitors/host. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return ['proceedings', 'monitors', 'host']

  def _get_setting(self):
    """
    Getter method for setting, mapped from YANG variable /proceedings/monitors/host/setting (string)
  ...
  def _set_setting(self, v, load=False):
    """
    Setter method for setting, mapped from YANG variable /proceedings/monitors/host/setting (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_setting is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_setting() directly.
  ...
  def _get_node(self):
    """
    Getter method for node, mapped from YANG variable /proceedings/monitors/host/node (string)
  ...
  def _set_node(self, v, load=False):
    """
    Setter method for node, mapped from YANG variable /proceedings/monitors/host/node (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_node is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_node() directly.
...
class yc_monitors_vnf_bd__proceedings_monitors(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__id = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:ietf:params:xml:ns:yang:vnf-bd', defining_module='vnf-bd', yang_type='string', is_config=True)
    self.__name = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:ietf:params:xml:ns:yang:vnf-bd', defining_module='vnf-bd', yang_type='string', is_config=True)
    self.__host = YANGDynClass(base=yc_host_vnf_bd__proceedings_monitors_host, is_container='container', yang_name="host", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:ietf:params:xml:ns:yang:vnf-bd', defining_module='vnf-bd', yang_type='container', is_config=True)
  ...
  def _get_id(self):
    """
    Getter method for id, mapped from YANG variable /proceedings/monitors/id (string)
  ...
  def _set_id(self, v, load=False):
    """
    Setter method for id, mapped from YANG variable /proceedings/monitors/id (string)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_id is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_id() directly.
  ...
  def _get_host(self):
    """
    Getter method for host, mapped from YANG variable /proceedings/monitors/host (container)
  ...
  def _set_host(self, v, load=False):
    """
    Setter method for host, mapped from YANG variable /proceedings/monitors/host (container)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_host is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_host() directly.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_host_vnf_bd__proceedings_monitors_host, is_container='container', yang_name="host", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:ietf:params:xml:ns:yang:vnf-bd', defining_module='vnf-bd', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """host must be of a type compatible with container""",
          'defined-type': "container",
          'generated-type': """YANGDynClass(base=yc_host_vnf_bd__proceedings_monitors_host, is_container='container', yang_name="host", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:ietf:params:xml:ns:yang:vnf-bd', defining_module='vnf-bd', yang_type='container', is_config=True)""",
        })
