...
class Environment:
    def __init__(self, topo, cli_mode=False):
        self.topo = topo
        ...
        self.nodes_info = {}
        LOG.debug("Experiment Instance Created")
        LOG.debug(f"{json.dumps(self.topo, indent=4)}")
    ...
    def _add_nodes(self):
        ...
        for node_id, node in nodes.items():
            ...
            if format == "docker":
                ...
                LOG.info("Node %s not added, unknown format %s", node_id, format)
